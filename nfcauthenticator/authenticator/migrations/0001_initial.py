...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="authenticator.estiamusermodel",
        ...
        migrations.CreateModel(
            ...
            bases=("authenticator.estiamusermodel",),
            managers=[
                ("objects", django.contrib.auth.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "device_type",
                    models.CharField(
                        choices=[("Computer", "computer"), ("Server", "server")],
                        default="Computer",
                        max_length=140,
                    ),
                ),
                ("ip_adress", models.CharField(default="", max_length=120, null=True)),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
