...
SECRET_KEY = "django-insecure-@j8vec_hnkv99go#!-ctor-qqw#c56f!ommf0tzj+m1g=j9hml"
...
AUTH_USER_MODEL = "authenticator.EstiamUser"
...
SIMPLE_JWT = {
    ...
    "USER_AUTHENTICATION_RULE": "nfcauthenticator.authenticator.permissions.user_authentication_rule",
    ...
    "TOKEN_OBTAIN_SERIALIZER": "nfcauthenticator.authenticator.serializers.ObtainTokenSerializer",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ESTIAM HACKHATON API",
    "DESCRIPTION": "API Async",
    "VERSION": "1.0.0",
